...
# ID룰 Email: cherry1024@gmail.com
...
print(str.find("o"))        # Hell*o* World -> 앞에서부터 찾아줌
print(str.rfind("o"))       # Hello W*o*rld -> 뒤에서부터 찾아줌
print(str.find("world"))    # 없으면 -1 출력
print(str.find("World"))    # 첫 글자의 인덱스 출력 -> 6
print(str.rfind("World"))   # 첫 글자의 인덱스 출력 -> 6
...
url = "www.naver.com"
start = url.find(".") + 1 => n을 의미함
end = url.rfind(".") => r 뒤에 있는 .을 의미함
val = url[start:end]
print(val)  # naver
